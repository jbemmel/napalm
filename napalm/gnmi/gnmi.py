...
#
# 2022-2-12 JvB updated for the Nanog84 Hackathon, copied from eos driver
#

"""
Napalm driver for multiple vendors using gNMI.
...
class gNMIDriver(NetworkDriver):
    """Napalm multi-vendor driver using gNMI."""

    def __init__(self, hostname, username, password, timeout=60, optional_args=None):
        """
        Initialize gNMI Driver.
        ...
        Optional args:
            ...
            * transport (string): gNMI transport
                - socket
                - http_local
                - http
                - https
    ...
    def _process_optional_args(self, optional_args):
        ...
        transport = optional_args.get("transport", "https")
    ...
    def commit_config(self, message="", revert_in=None):
        ...
        raise NotImplementedError(
          "commit_config not implemented for this platform"
        )
    ...
    def confirm_commit(self):
        ...
        raise NotImplementedError(
          "confirm_commit not implemented for this platform"
        )
